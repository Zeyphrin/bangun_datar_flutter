...
class luasLingkaran extends StatefulWidget {
  ...
  @override
  State<luasLingkaran> createState() => _LuasSegitigaState();
}

class _LuasSegitigaState extends State<luasLingkaran> {
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          width: 324,
                          child: Text(
                            'bangun datar dua dimensi yang terbentuk dari sekumpulan titik dengan jarak yang konstan atau teratur dari titik tetap pada sebuah bidang.',
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    image: DecorationImage(
                                      image:
                                          AssetImage('images/rumus-lingkaran.jpg'),
                                      fit: BoxFit.cover,
                                    ),
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          width: 330,
                          height: 40,
                          child: myTextField(ctrJari, "Jari-Jari (cm)"),
                        ),
                      ),
                      ElevatedButton(
                        ...
                        child: Obx(
                          () {
                            String hasilText = "";
                              ...
                              hasilText = controller.hasilLuasLingkaran.value.toString();
                            
                            return Text(
                              "hasil dari luas lingkaran dengan jari-jari ${ctrJari.text} cm adalah:  ${hasilText} cm²",
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 10,
                                fontFamily: 'Montserrat',
